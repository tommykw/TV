...
object MovieList {
    val MOVIE_CATEGORY = arrayOf("Category Zero", "Category One", "Category Two", "Category Three", "Category Four", "Category Five")

    var list: MutableList<Movie>

    fun setupMovies(): List<Movie> {
        list = ArrayList<Movie>()
        val title = arrayOf("Zeitgeist 2010_ Year in Review", "Google Demo Slam_ 20ft Search", "Introducing Gmail Blue", "Introducing Google Fiber to the Pole", "Introducing Google Nose")
    ...
    private fun buildMovieInfo(category: String, title: String,
                               ...
                               bgImageUrl: String): Movie {
        val movie = Movie()
        movie.id = Movie.getCount()
        Movie.incCount()
        movie.title = title
        ...
        movie.backgroundImageUrl = bgImageUrl
